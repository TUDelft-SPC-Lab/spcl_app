...
from bleak_connection import BLEBadgeConnection
import sys
...
class Connection:
    ...
    def handle_status_request(self):
        try:
            ...
            raise Exception(
                "Could not get status for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_start_microphone_request(self):
        try:
            ...
            raise Exception(
                "Could not start mic for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_stop_microphone_request(self):
        try:
            ...
            raise Exception(
                "Could not stop mic for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_start_scan_request(self):
        try:
            ...
            raise Exception(
                "Could not start scan for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_stop_scan_request(self):
        try:
            ...
            raise Exception(
                "Could not stop scan for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_start_imu_request(self):
        try:
            ...
            raise Exception(
                "Could not start IMU for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_stop_imu_request(self):
        try:
            ...
            raise Exception(
                "Could not stop IMU for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_identify_request(self):
        try:
            ...
            raise Exception(
                "Could not identify for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_restart_request(self):
        try:
            ...
            raise Exception(
                "Could not restart for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
    ...
    def handle_get_free_space(self):
        try:
            ...
            raise Exception(
                "Could not get free space for participant "
                + str(self.badge_id)
                + " , error:"
                + str(err)
            )
